      ...
      <div className="template-lib-content-wrapper">
        ...
        <div className="template-lib-text-container">
          <h1 className="template-lib-heading">
            ...
            <span className="template-lib-highlight">
              Endless Templates.
            </span>{" "}
          ...
          <p className="template-lib-description">
            Bold or classic, playful or professional—we've got a template for
            every kind of email, so your messages always hit the mark! Big sale?
            Office update? Birthday shoutout? We've got beautifully designed
            templates to make sure your emails shine—every single time.
          </p>
          <button 
            className="mm-dark-try-button library"
