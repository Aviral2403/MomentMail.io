...
const Workflow = () => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: "50px 0px -30px 0px", // Start detecting earlier
      }
    );
  ...
  return (
    <>
      <div className="workflow-container" ref={workflowRef}>
        <div className="workflow-cards">
          <div
            className={`workflow-card connect-card ${
              isVisible ? "animate-from-left" : ""
            }`}
          >
            ...
            <div className="card-content">
              ...
              <p>
                Seamlessly connect your drive import and select the sheet and
                its column with emails.
              </p>
            </div>
          </div>
          <div
            className={`workflow-card select-card ${
              isVisible ? "animate-from-bottom" : ""
            }`}
          >
          ...
          <div
            className={`workflow-card send-card ${
              isVisible ? "animate-from-right" : ""
            }`}
          >
