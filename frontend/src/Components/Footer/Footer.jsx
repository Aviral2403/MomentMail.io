      ...
      <div className="footer-container">
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {currentYear} MomentMail. All rights reserved.
          </p>
        ...
        <div className="developer-socials-credits">

 

        <div className="developer-credit">
          <p>            
             Developed by Aviral Khandelwal
          </p>
        </div>
        <div className="footer-social">
            <a
              href="https://www.linkedin.com/in/aviral-khandelwal-a17236322/"
              target="_blank"
            ...
            <a
              href="https://github.com/Aviral2403"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
            >
